...
import divine from "../../img/upcomingEvent2.jpg";
      ...
      <div className="overflow-hidden">
        <div className="relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full p-4 flex flex-col items-center justify-center">
              ...
              <form onSubmit={handleSubmit}>
                <div className="flex md:flex-row flex-col md:rounded-md overflow-hidden md:max-w-md mx-auto w-full bg-gray-300 backdrop-blur-md">
                  ...
                  <input
                    type="button"
                    value="subscribe"
                    className="cursor-pointer py-3 text-base font-[700] border-none outline-none focus:border-none capitalize px-3 bg-yellow-700 text-white tracking-[3px]"
                  />
                </div>
              </form>
            </div>
            <Link
              to="/"
              className="mt-4 capitalize tracking-widest font-medium text-base text-yellow-400 hover:scale-105 transition-all ease-in duration-300">
              go to home
            </Link>
          </div>
        </div>
